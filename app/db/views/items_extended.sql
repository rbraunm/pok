SELECT
  ...
  -- nodrop=0 means "No Drop" (non-tradable), nodrop=1 means tradable. Using NOT to mirror in-game flag.
  NOT i.nodrop                              AS item_is_no_drop,
  -- norent=0 means "No Rent" (temporary, not persisted). Using NOT so 1 = temporary for display/logic.
